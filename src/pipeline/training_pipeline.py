...
from src.components.data_tarnsformation import DataTransformation
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        """This method of Training Pipiline class is responsible for starting data ingestion component"""
        try:
    ...
    def start_data_validation(self , data_ingestion_artifact : DataIngestionArtifact) -> DataValidationArtifact:
        logging.info("Entered the data validation method of TrainingPipeline class")
        try:
    ...
    def start_model_trainer(self , data_transformation_artifact  : DataTransformationArtifact) -> ModelTrainerArtifact:
        ...
        try:
            model_trainer = ModelTrainer(
                ...
                model_trainer_config= self.model_tainer_config
            )
