...
class VehicleData:
    ...
    def get_vehicle_data_as_dict(self):
        ...
        """
        logging.info("Entered get_vehicle_data_as_dict method as Vehicle Data Class")
        ...
        try :
            ...
            logging.info("Created Vehice data dictionary")
            logging.info("exited from get_vehicle_data_as_dict method as Vehicle data Class")
...
class VehicleDataClassifier:
    ...
    def predict(self , dataframe) -> str :
        ...
        """
        try:
            logging.info("Entered the predict method of VehicleDataClassifier Class")
